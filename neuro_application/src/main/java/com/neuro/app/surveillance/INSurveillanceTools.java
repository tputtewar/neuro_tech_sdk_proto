...
public final class INSurveillanceTools {

	// ===========================================================
	// Private static fields
	// ===========================================================

	private static INSurveillanceTools instance;
	...
	public static INSurveillanceTools getInstance() {
		synchronized (INSurveillanceTools.class) {
			if (instance == null) {
				instance = new INSurveillanceTools();
			}
			return instance;
		}
	}
